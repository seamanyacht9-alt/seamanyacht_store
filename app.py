...
# ==========================================
# หน้า 5: ประวัติการจัดซื้อ & พิมพ์บิล
# ==========================================
    ...
    if po_log_df.empty:
        ...
        # ฟีเจอร์: เลือก PO เพื่อเปิดดูและพิมพ์เป็น PDF (อัปเดตย้าย ผู้ขอซื้อ/ร้านค้า ลงตาราง)
        ...
        if selected_po_to_print:
            ...
            for idx, row in po_data.iterrows():
                ...
                # ตัดเอาเลขลำดับหลังจากขีด เช่น PO_0004-1 กลายเป็น 1
