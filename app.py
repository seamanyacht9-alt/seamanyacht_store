    ...
    if po_log_df.empty:
        ...
        if selected_po_to_print:
            ...
            <head>
                ...
                <style>
                    /* บีบขอบกระดาษและฟอนต์ให้เล็กลงนิดนึง เพื่อให้จุของได้เยอะขึ้น */
                    ...
                    /* ลดช่องไฟ (Padding) ในตารางลงจาก 10px เหลือ 4px */
                    ...
                    /* ป้องกันไม่ให้ลายเซ็นโดนตัดขาดครึ่ง */
            ...
            html_invoice += f"""
                ...
                <script>
                    function getPDFOptions() {{
                        return {{
                            margin:       [5, 5, 5, 5], /* ลดขอบกระดาษ PDF ให้เล็กลง */
