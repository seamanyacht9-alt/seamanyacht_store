...
# ==========================================
# หน้า 5: ประวัติจัดซื้อ & รับของเข้าคลัง 
# ==========================================
elif menu == "📑 ประวัติจัดซื้อ & รับของเข้าคลัง":
    ...
    if po_log_df.empty:
        ...
        if selected_po_to_print:
            ...
            """
            st.info("👇 เลื่อนดูเอกสารด้านล่าง แล้วกดปุ่มพิมพ์ (Print) ในกรอบเพื่อ Save เป็นไฟล์ PDF ได้เลยครับ")
        ...
        # ---------------------------------------------
        # โซน แท็บจัดการบิล (แก้ไขกดรับผิด / ตีกลับ / ยกเลิก / ลบ) (ใหม่ล่าสุด)
        # ---------------------------------------------
                ...
                with st.form("return_po_form"):
                    ...
                    if st.form_submit_button("📦 ยืนยันตีกลับสินค้า"):
                        if not return_item:
                            ...
                            # ถ้าเคยรับของเข้าสต๊อกไปแล้ว ต้องดึงออกก่อน
